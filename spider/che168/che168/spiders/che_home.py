...
#        print(url_detail)
    ...
    def parse_detail(self,response):
        ...
        item['car_body'] = response.xpath('//div[@id="configContent"]/table[2]/tbody/tr[13]/td[2]/text()').extract()     #后备箱容积
        item['car_seat'] = response.xpath('//div[@id="configContent"]/table[2]/tbody/tr[11]/td[2]/text()').extract()   #座位
        item['car_size'] = response.xpath('//div[@id="configContent"]/table[1]/tbody/tr[13]/td[2]/text()').extract()    #长宽高
        item['car_fuel_consumption'] = response.xpath('//div[@id="configContent"]/table[1]/tbody/tr[20]/td[2]/text()').extract()     #油耗
